...
import org.vaadin.example.views.main.MainView;
import org.vaadin.example.views.helloworld.HelloWorldView;
import org.vaadin.example.views.about.AboutView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "webapp", shortName = "webapp",  enableInstallPrompt = false)
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "webapp logo"));
        logoLayout.add(new H1("webapp"));
