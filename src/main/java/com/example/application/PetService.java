...
public class PetService {
	...
	public synchronized List<Pet> findAll(String stringFilter) {
        ...
        Collections.sort(arrayList, (Pet o1, Pet o2) -> (int) (o2.getId() - o1.getId()));
	...
	/**
	 * @return the amount of all Pets in the system
	 */
	...
	/**
	 * Persists or updates Pet in the system. Also assigns an identifier
